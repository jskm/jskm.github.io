...
BLOG_AUTHOR = "jskm"  # (translatable)
BLOG_TITLE = "Noetic Circuits"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jskm.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jskm.github.io/"
BLOG_EMAIL = "jskm19@gmail.com"
BLOG_DESCRIPTION = "jskm's development blog."  # (translatable)
